          ...
          <TableBody>
            {data.map((row, index) => (
              <StyledTableRow key={row.name}>
                ...
                <StyledTableCell align="center">{row.catg}</StyledTableCell>
                <StyledTableCell align="center" multiline style={{maxLines:'10',width:'500px'}}>{row.description}</StyledTableCell>
